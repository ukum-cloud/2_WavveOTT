  ...
  return (
    <main>
      <div className="signup">
        <p className="title"><span>이메일과 비밀번호만으로</span>
Wavve를 즐길 수 있어요!</p>
        <form action="">
          <label className="input-text">
            <span className="label-text">이메일</span>
            <input type="text" value='wavve@example.com' />
          </label>
          <p className="text-info">로그인, 비밀번호 찾기, 알림에 사용되니 정확한 이메일을 입력해 주세요.
          ...
          <p className="text-info">비밀번호는 8~20자 이내로 영문 대소문자, 숫자, 특수문자 중 3가지 이상 혼용하여 입력해 주세요.
            {/* 비밀번호는 8~20자 이내로 영문 대소문자, 숫자, 특수문자 중 3가지 이상 혼용하여 입력해 주세요.연속된 숫자 또는 4자 이상의 동일 문자는 비밀번호로 사용할 수 없습니다. */}
          </p>
        </form>
        <div className="btn-box">
          <button type="submit" className="btn middle grey wFull">Wavve 회원가입</button>
        </div>
        <div className="btn-box-other">
          ...
          <p className="text-info-dot">SNS계정으로 간편하게 가입하여 서비스를 이용하실 수 있습니다.
