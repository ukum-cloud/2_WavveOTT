    ...
    <main style={{ paddingTop: "90px" }}>
      ...
      <div className="inner">
        <ul className="common-btn-list">
          ...
          <li>
            ...
            <button className="btn small secondary" onClick={() => handleOpenModal('default')}>
              Default 모달 열기
            </button>
            <button className="btn small secondary" onClick={() => handleOpenModal('large')}>
              Large 모달 열기
            </button>
            {/* ----- // 모달 테스트 버튼------ */}
          </li>
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal} size={modalSize}>
        ...
        <div className="modal-content">
          <p>
            현재 모달 크기는 **{modalSize}** 입니다.
          </p>
          <p>
            이 모달은 부모 컴포넌트의 상태로 크기가 동적으로 변경됩니다.
          </p>
        </div>
