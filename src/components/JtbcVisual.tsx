...
import bgMain from "/images/visual/bg-jtbc.png";
import "./scss/JtbcVisual.scss";

const JTBCVisual: React.FC = () => {
  ...
  return (
    <div className="jtbc-container">
      {/* 1. 텍스트 레이어 */}
      <div className="title-box">
        <h2>
          <img src="/images/visual/jtbcLogo.svg" alt="JTBC" />
        </h2>
        <p>익숙하지만 늘 새로운 즐거움 </p>
      </div>
